...
import { Package, ArrowUpDown, ShoppingCart, Plus, Warehouse, TrendingUp } from 'lucide-react'
...
export default function DashboardAdmin() {
  ...
  useEffect(() => {
    async function cargar() {
      ...
      const [{ count: productos }, { count: movHoy }, { count: pedidos }, { data: stockData }] = await Promise.all([
